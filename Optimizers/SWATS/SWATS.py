...
class SWATS(Optimizer):
    r"""Implements SWATS algorithm.
    It has been proposed in `Improving Generalization Performance by Switching from Adam to SGD`.
    ...
    A PyTorch implementation can be found at: https://github.com/Mrpatekful/swats
    """
